      ...
      <section id="experiences" className="border-t border-white/5 bg-[#080A0C]">
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 py-24 md:py-32">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-[1px] bg-white/10">
            {experiences.map((exp) => (
              <button key={exp.id} onClick={() => openExpDetail(exp.id)} className="group bg-[#050607] text-left cursor-pointer">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-12 text-[13px]">
              <div>
                ...
                <div className="space-y-2 text-white/70">
                  ...
                  <div>Telegram</div>
                  <div>Max Messenger</div>
                  <div className="text-[12px] text-white/50 mt-2">hello@kori.kamchatka</div>
                </div>
              </div>
              <div>
                <div className="text-white/40 mb-3">Соцсети</div>
                <div className="space-y-2 text-white/70"><div>Instagram</div><div>YouTube</div></div>
              </div>
              <div>
                <div className="text-white/40 mb-3">Пресса</div>
                <div className="space-y-2 text-white/70"><div>Forbes Life</div><div>AD Russia</div></div>
              </div>
              <div>
                <div className="text-white/40 mb-3">Правовое</div>
                <div className="space-y-2 text-white/70"><div>Политика</div><div>Оферта</div></div>
              </div>
            </div>
          </div>
